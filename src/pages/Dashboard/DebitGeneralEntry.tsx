...
<div className="">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 ">
        ...
        <div>
          ...
          {/* <input type="date" className="w-full border p-2 rounded-md bg-white shadow-md" /> */}
      ...
      {/* Total Amount */}
      {/* <div className="w-full bg-gray-300 rounded-md py-4"> */}
      ...
      <div className="mt-8 text-right">
        <button className="bg-[#3bb0df] hover:bg-[#2a81a3] shadow-md text-white px-6 py-2 md:w-52 rounded-md">
          Submit
        </button>
      </div>
      </div>
