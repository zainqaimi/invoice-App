...
const Product: React.FC = () => {
  ...
  const columns = [
    {
      title: (
        <div onClick={() => handleSort("productName")} className="flex items-center justify-between cursor-pointer">
          Product Name
    ...
    {
      title: (
        <div onClick={() => handleSort("weightType")} className="flex items-center justify-between cursor-pointer">
          Weight Type
    ...
    {
      title: (
        <div onClick={() => handleSort("retailPrice")} className="flex items-center justify-between cursor-pointer">
          Retail Price
    ...
    },
    {
      ...
      key: "isActive",
      render: (isActive: boolean) => (
        <span className={`px-2 py-1 rounded-md text-white ${isActive ? "bg-green-500" : "bg-red-500"}`}>
          {isActive ? "Active" : "Inactive"}
        </span>
      ),
    },
...
//     <div className="p-4 bg-gray-50 shadow-sm min-h-screen">
//       <div className="mb-4">
//         <button onClick={() => navigate(-1)} className="flex items-centern text-[#3bb0df]">
//           <IoMdArrowRoundBack size={16} />
//           <span>Back</span>
//         </button>
//       </div>
...
//       {/* Modal */}
//       <Modal title={editingKey !== null ? "Edit Product" : "Add Product"} open={isModalOpen} onCancel={handleCancel} footer={null}>
//         <Form form={form} layout="vertical">
//           <Form.Item name="productName" label="Product Name" rules={[{ required: true }]}>
//             <Input />
//           </Form.Item>
//           <Form.Item name="weightType" label="Weight Type" rules={[{ required: true }]}>
//             <Select>
