...
//     className="cursor-pointer text-[#00a8ec] text-lg"
//   />
// );
...
//         </Space>
//         <div className="flex items-center space-x-2">
//           <h2 className="lg:text-2xl text-lg font-semibold hidden md:block mb-1">Tassco</h2>
//           <Dropdown menu={debitMenu} trigger={["hover"]}  className="w-8 h-8 md:w-10 md:h-10 cursor-pointer">
